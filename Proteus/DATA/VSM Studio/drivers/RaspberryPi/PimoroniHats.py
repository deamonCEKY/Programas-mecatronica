...
class PimoroniExplorerHat:
   ...
   def setOutput(self,pin,value):
      pinArray = [6,12,13,16]
      if value:
         GPIO.output(pinArray[pin-1], True)
      else:
         GPIO.output(pinArray[pin-1], False)
   ...
   def readInput(self,pin):
      pinArray = [23,22,24,25]
      return GPIO.input(pinArray[pin-1])
