...
/*****                                                          *****/
/*****             Virtual Front Panel Server for Yun           *****/
/*****                                                          *****/
/********************************************************************/
/********************************************************************/
 ...
 { // Start the bridge:   
   ...
   do 
    { process.begin(F("python"));  
      process.addParameter(F("-u")); // unbuffered stdin/out
      process.addParameter(F("/vsm/server.py")); 
      process.addParameter(String(port)); 
      process.runAsynchronously(); 
      delay(3000);      
    } while (!process.running());   
   Console.println(F("Server Started"));         
 }
...
StreamList &Server::parseArgs ()
 { return requestList.begin(&process);
 }
