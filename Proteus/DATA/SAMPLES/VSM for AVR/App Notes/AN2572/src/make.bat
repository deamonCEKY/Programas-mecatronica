...
set include_dirs=.\core

del *.cof

set compiler_args=-mcpu=%CPU% -c  -x c -D__%CPU%__ -mdfp="C:/Program Files (x86)/Microchip/MPLABX/v5.35/packs/Microchip/ATtiny_DFP/2.1.63"  -Wl,--gc-sections -O0 -Og -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -Wall -DXPRJ_default=default -gdwarf-3
...
"%cpath%\%linker%" %linker_args% %build_dir%/main.o %build_dir%/mcc.o %build_dir%/device_config.o %build_dir%/protected_io.o %build_dir%/pin_manager.o  -o project.elf
