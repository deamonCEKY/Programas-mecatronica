...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1360937237/bod.o: ../src/bod.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O0 -Og -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -DDEBUG -I"../include" -I"../utils" -I"../utils/assembler" -I"../" -I"../Config" -Wall -DXPRJ_Debug=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3 -std=gnu99     -MD -MP -MF "${OBJECTDIR}/_ext/1360937237/bod.o.d" -MT "${OBJECTDIR}/_ext/1360937237/bod.o.d" -MT ${OBJECTDIR}/_ext/1360937237/bod.o -o ${OBJECTDIR}/_ext/1360937237/bod.o ../src/bod.c 
...
${OBJECTDIR}/_ext/1360937237/bod.o: ../src/bod.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360937237/bod.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/bod.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O0 -Og -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -DDEBUG -I"../include" -I"../utils" -I"../utils/assembler" -I"../" -I"../Config" -Wall -DXPRJ_Debug=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3 -std=gnu99     -MD -MP -MF "${OBJECTDIR}/_ext/1360937237/bod.o.d" -MT "${OBJECTDIR}/_ext/1360937237/bod.o.d" -MT ${OBJECTDIR}/_ext/1360937237/bod.o -o ${OBJECTDIR}/_ext/1360937237/bod.o ../src/bod.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_Debug=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp=${DFP_DIR}   -gdwarf-2 -Wl,--gc-sections -O0 -Og -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -DDEBUG -I"../include" -I"../utils" -I"../utils/assembler" -I"../" -I"../Config" -Wall -std=gnu99 -gdwarf-3     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -o dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -Wl,--start-group  -Wl,-lm -Wl,--end-group  -Wl,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.map  -DXPRJ_Debug=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O0 -Og -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -DDEBUG -I"../include" -I"../utils" -I"../utils/assembler" -I"../" -I"../Config" -Wall -std=gnu99 -gdwarf-3     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -o dist/${CND_CONF}/${IMAGE_TYPE}/Advanced_Keypad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -Wl,--start-group  -Wl,-lm -Wl,--end-group 
